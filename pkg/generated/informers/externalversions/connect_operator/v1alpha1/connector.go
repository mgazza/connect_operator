...
import (
	...
	versioned "connect_operator/pkg/generated/clientset/versioned"
	internalinterfaces "connect_operator/pkg/generated/informers/externalversions/internalinterfaces"
	v1alpha1 "connect_operator/pkg/generated/listers/connect_operator/v1alpha1"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.MgazzaV1alpha1().Connectors(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.MgazzaV1alpha1().Connectors(namespace).Watch(context.TODO(), options)
			},
		},
		&connectoperatorv1alpha1.Connector{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *connectorInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&connectoperatorv1alpha1.Connector{}, f.defaultInformer)
}
